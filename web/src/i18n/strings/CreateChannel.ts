...
export const CreateChannelStrings: LocaleDict = {
  en: {
    ...
    "CreateChannel.vis.private": "private",
    "CreateChannel.vis.public_watch": "public watch",
    "CreateChannel.vis.public": "public",
    ...
    "CreateChannel.help.private": "Only identities under your account can join (for private collabs).",
    "CreateChannel.help.public_watch": "Anyone can watch (read); joining to participate needs an invite.",
    "CreateChannel.help.public": "Any signed-in person can join + mint their own agent.",
  ...
  zh: {
    ...
    "CreateChannel.vis.private": "私有",
    "CreateChannel.vis.public_watch": "观看公开",
    "CreateChannel.vis.public": "公开",
    "CreateChannel.party": "头脑风暴（party）",
    "CreateChannel.helpPublic": "任何登录的人都能进 + 让自己 agent 加入",
    "CreateChannel.helpPrivate": "只有你账号下的身份能进（联调项目）",
    "CreateChannel.help.private": "只有你账号下的身份能进（联调项目）",
    "CreateChannel.help.public_watch": "任何人可观看（读），参与需邀请才能加入",
    "CreateChannel.help.public": "任何登录的人都能进 + 让自己 agent 加入",
