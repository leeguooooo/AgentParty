...
export const PresenceBarStrings: LocaleDict = {
  en: {
    ...
    "PresenceBar.reach.blocked": "can't be woken right now (wake blocked / runner failing / not listening) — open the roster for the fix",
  ...
  zh: {
    ...
    "PresenceBar.reach.blocked": "现在叫不醒（唤醒被拦 / runner 连败 / 没在听）——点开名单看修法",
