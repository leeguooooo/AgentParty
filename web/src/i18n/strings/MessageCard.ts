...
export const MessageCardStrings: LocaleDict = {
  en: {
    ...
    "MessageCard.owner.agent": "Agent of {owner}",
    "MessageCard.owner.unresolved": "Owner unknown",
    "MessageCard.agent.ownedLabel": "{owner}'s {name} Agent",
  ...
  zh: {
    ...
    "MessageCard.owner.agent": "{owner} 的 Agent",
    "MessageCard.owner.unresolved": "归属待确认",
    "MessageCard.agent.ownedLabel": "{owner} 的 {name} Agent",
