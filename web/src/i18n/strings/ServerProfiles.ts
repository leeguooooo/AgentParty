...
export const ServerProfileStrings: LocaleDict = {
  en: {
    ...
    "ServerProfiles.add.originHint": "HTTPS, or plain HTTP on a private network (localhost, 10.x / 172.16-31.x / 192.168.x, *.local, *.internal). Public hosts need HTTPS.",
  ...
  zh: {
    ...
    "ServerProfiles.add.originHint": "HTTPS，或私网内的明文 HTTP（localhost、10.x / 172.16-31.x / 192.168.x、*.local、*.internal）。公网地址必须 HTTPS。",
